...
Revision ID: b2878f37a2fc
Revises: 
Create Date: 2023-12-15 00:27:00.626726
...
def upgrade() -> None:
    ...
    sa.Column('category', sa.Enum('clothes', 'shoes', 'children_goods', 'electronics', 'appliances', 'beauty', 'accessories', 'household_products', 'household_chemicals_and_hygiene', 'sports_recreation_and_health', 'books', name='categoryenum'), nullable=True),
    sa.Column('image', sa.String(), nullable=True),
